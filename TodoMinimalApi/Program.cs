...
using TodoMinimalApi.Utils;
using TodoMinimalApi.ViewModels;

var builder = WebApplication.CreateBuilder(args);
const string jwtPolicyName = "jwt";
...
builder.Services.AddRateLimiter(limiterOptions =>
{
    ...
    limiterOptions.OnRejected = (context, cancellationToken) =>
    {
        ...
        context.HttpContext.RequestServices.GetService<ILoggerFactory>()?
            ...
            .LogWarning("OnRejected: {Utils.GetUserEndPoint}", Utils.GetUserEndPoint(context.HttpContext));
...
// Add Validator scope
builder.Services.AddScoped<IValidator<TodoInput>, TodoInputValidator>();
